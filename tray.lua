--[[
  tray.lua - custom tray generator for pick&place machines
...
-- creates a new tray with file-suffix based tray type detection
-- also draws dimension layer
function new_tray(fname)
